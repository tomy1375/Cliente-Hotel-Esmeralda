...
//     // Almacenar mensajes en el localStorage cada vez que se actualiza el estado de mensajes
//     useEffect(() => {
//       localStorage.setItem('messages', JSON.stringify({ mensajes, salasClientes, lastSelectedRoom: selectedRoom }));
...
//   const handleRoomClick = (salaId) => {
//     setSelectedRoom(salaId);
//     setLoadingMessages(true);
//     setTimeout(() => {
      
//       const mensajesDeSala = mensajes[salaId] || [];
//       setMensajes(mensajesDeSala);
...
//               <span
//                 onClick={() => handleRoomClick(salasClientes[sala])}
...
//         {!loadingMessages && selectedRoom && mensajes[selectedRoom] && mensajes[selectedRoom].map((mensaje, index) => (
//           <div
//             key={index}
//             className={`mensaje ${
//               mensaje.tipo === 'cliente' ? 'bg-d text-black' : 'bg-gray-300 text-gray-800'
//             } p-2 rounded mb-2`}
//           >
...
//         <button type="submit" className="bg-amber-300 hover:bg-amber-400 transition-colors px-4 py-2 rounded focus:outline-none">
//           Send
//         </button>
//       </form>
