...
const ProfileImage = ({ src, alt }) => (
  <img
    ...
    src={src}
    alt={alt}
    className="shrink-0 mx-auto mt-2.5 rounded-full  hover:brightness-75 transition-all duration-300 aspect-square bg-neutral-800 h-[100px] w-[100px] max-md:mt-10"
  />
);
...
function ProfileUser() {
  ...
  const [isModalOpenReservation, setIsModalOpenReservation] =
          ...
          <div className="flex flex-col w-[44%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow px-9 pt-8 pb-16 mx-auto w-full text-lg text-white rounded-2xl shadow-sm bg-v bg-opacity-90 max-md:px-5 max-md:mt-10">
              <img
                ...
                src={
                  user?.imageUrl ||
                  "https://cdn.builder.io/api/v1/image/assets/TEMP/26c4709492c00da65d6fa729fa2ab40423d04859a3760111aea4ba2e209a09e2?apiKey=c9ddec6ddbc94b67bd3fdb2f72981df8&"
                }
                alt="Profile"
            ...
            <div className="flex flex-col max-md:mt-10">
              <div className="flex flex-col justify-center">
                <div className="px-8 py-6 rounded-2xl border border-solid border-stone-500 max-md:px-5">
                  <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                    <div
                      className="flex flex-col w-[31%] max-md:ml-0 cursor-pointer "
                      onClick={() => setIsModalOpen(true)}
                    >
                      <ProfileImage
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/d3dd099163391e6add3e42b3f27ed29a7a59371a0b76eb3e6955715b8982e482?apiKey=c9ddec6ddbc94b67bd3fdb2f72981df8&"
              ...
              <div className="flex flex-col justify-center mt-12 max-md:mt-10">
                <div className="px-9 py-6 rounded-2xl border border-solid border-stone-500 max-md:px-5">
                  <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                    <div className="flex flex-col w-[32%] max-md:ml-0 max-md:w-full">
                      <ProfileImage
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/e13622bd797e9797b741c9103bf3882c3a1f4e12c870a7951fe22a2cf1c71fc1?apiKey=c9ddec6ddbc94b67bd3fdb2f72981df8&"
                        alt="Security"
                      />
                    </div>
                ...
                <div>
                  <div className="flex px-9 py-6 rounded-2xl border border-solid border-stone-500 max-md:px-5 mt-9">
                    <div
                      className="flex flex-col w-[32%] max-md:ml-0 max-md:w-full cursor-pointer"
